...
def raw_handler_identify():
    ...
    "baseURL":BASE_URL,
    "protocolVersion": "2.0","adminEmail": "admin@example.org","earliestDatestamp":datetime.utcnow().strftime("%Y-%m-%dT%H:%M:%SZ"),
    "deletedRecord":"no",
        ...
        "formats": [
            {
                ...
                "schema": OAI_DATACITE_SCHEMA,
                "metadataNamespace": OAI_DATACITE_NS
            }
        ]
    })
