...
def json_to_datacite(json_sparql_response, mapping):
    root = ET.Element("resource", xmlns="http://datacite.org/schema/kernel-4")

    for binding in json_sparql_response["results"]["bindings"]:
